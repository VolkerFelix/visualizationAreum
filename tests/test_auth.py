...
def test_successful_registration(client, mock_register_success, mock_login_success):
    ...
    assert response.status_code == 200
    mock_register_success.assert_called_once_with('newuser', 'password123', 'newuser@example.com')
...
def test_failed_registration(client, mock_register_failure):
    ...
    assert response.status_code == 200
    mock_register_failure.assert_called_once_with('existinguser', 'password123', 'existinguser@example.com')
